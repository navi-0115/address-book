...
function renderEditContactsFormById(id) {
  ...
  updateContactModal.querySelector(".update-contact-body").innerHTML = `
      ...
      <div class="flex items-center space-x-4">
          <button type="submit"
              class="text-white bg-gray-800 hover:bg-gray-600 focus:ring-4 focus:outline-none focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-gray-600 dark:hover:bg-gray-700 dark:focus:ring-gray-800">Update
              contact
          </button>
      </div>
    </form>
