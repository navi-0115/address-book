...
function renderEditContactsFormById(id) {
  ...
  updateContactModal.querySelector(".update-contact-body").innerHTML = `
      ...
      <div class="flex items-center space-x-4">
          <button type="submit"
              class="text-white bg-green-500 hover:bg-green-600 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">Update
              contact
          </button>
      </div>
    </form>
